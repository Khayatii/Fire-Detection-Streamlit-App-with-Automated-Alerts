...
def main():
    ...
    # Load the logo image
    logo_path = 'path_to_logo/logo.png'  # Replace with the correct path to your logo image
    try:
        logo_image = Image.open(logo_path)
        st.sidebar.image(logo_image, use_column_width=True, caption="Generated by DALL-E")
