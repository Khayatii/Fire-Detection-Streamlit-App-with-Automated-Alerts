...
TELEGRAM_BOT_TOKEN = '7843011691:AAG99Q1KGx70DKBb6r8EF__9_vBsSlj1e6c'  # Replace with your actual bot token
TELEGRAM_CHAT_ID = '6723260132'  # Your phone number

# Function to send message and photo to Telegram
async def send_telegram_message(image_bytes, detection_text):
...
def main():
    ...
    if image:
        ...
        # Create columns for download and send buttons
        col1, col2 = st.columns(2)
        ...
        with col2:
            # Create a send to Telegram button
            if st.button('Send Prediction'):
                try:
                    with st.spinner("Sending to Telegram..."):
                        # Reset buffer position
                        image_buffer.seek(0)
                        # Run the async function
                        asyncio.run(send_telegram_message(image_buffer.getvalue(), text))
