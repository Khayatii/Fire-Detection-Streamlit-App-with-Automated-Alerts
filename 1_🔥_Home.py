...
def main():
    ...
    # Check if fire is detected in the prediction text
    if "fire" in text.lower():  # Check if the text indicates fire
        # Reset the buffer position to the beginning
        image_buffer.seek(0)
        send_to_telegram(prediction, text, TELEGRAM_BOT_TOKEN, CHAT_ID)
        st.success("Fire detected! Alert sent to Telegram automatically.")
